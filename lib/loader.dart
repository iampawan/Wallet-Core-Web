...
Future<void> loadJs() async {
  ...
  loader.append(
      ScriptElement()..src = '/node_modules/@trustwallet/wallet-core/dist/lib/wallet-core.js');
  loader.append(
      ScriptElement()..src = '/node_modules/@trustwallet/wallet-core/dist/generated/core_proto.js');
...
void onRuntimeInitialized() {
  ...
  final key = HexCoding.decode("5caa3a74154cee16bd1b570a1330be46e086474ac2f4720530662ef1a469662c");
  ...
  final decrypted = utf8.decode(AES.decryptCBC(key, cipher, iv, AESPaddingMode.pkcs7));
  const expected =
